package com.ultlog.common.constant;
...
public interface ESConstant {
    ...
    String LOG_INDEX_NAME = "ult_index";

    String PROJECT_INDEX_NAME = "ult_project";

    String MODULE_INDEX_NAME = "ult_module";
